    ...
    return (
        <>
            <div className='w-full flex sm:flex-col md:flex-col lg:flex-row   justify-center gap-5 md:w-auto text-center'>
                <Link className='lg:border-r-2  px-5 ' href={'/admin/crear-paquetes'}>
            ...
            <div className='flex flex-col-reverse md:flex-row justify-center items-center shadow-md p-5 w-full bg-red-600'>
                <Logo />
            </div>
